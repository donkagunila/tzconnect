...
//     {
//         Route::get('all', 'ServiceController@index')->name('all');
//         Route::get('transport', 'ServiceController@transport')->name('transport');
//         Route::get('transport/create', 'ServiceController@createtransport')->name('transport.create');
//         Route::post('transport/create', 'ServiceController@addtransport')->name('transport.add');
//         Route::get('enternainment', 'ServiceController@enternainment')->name('enternainment');
//         Route::get('mc', 'ServiceController@mc')->name('mc');
//         Route::get('hall', 'ServiceController@hall')->name('hall');
